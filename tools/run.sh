...
# tmp_screenshot_list=$artifacts_dir/screenshot.list
...
bash $script_dir/compare_list.sh $attested_screenshots_dir $current_screenshots_dir $artifacts_dir $raw_junit
